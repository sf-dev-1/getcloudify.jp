 ...
 *A:* <a href="http://getcloudify.org/downloads/get_cloudify.html">こちら</a>,でダウンロードして、そのまま<a href="http://docs.getcloudify.org/3.3.1/intro/getting-started/">『はじめに』</a>guideを開き、指示に従ってください。
 ...
 *A:* 利用可能なブループリントはすべて<a href="https://github.com/cloudify-cosmo">Github</a>にあります。Cloudifyウィジェットやインタラクティブシェル（近日予定）を試し、事前にブループリントの動作を確認することができます。Cloudifyのブループリントの始め方についての"動画のチュートリアル":/cloudifysourcetv.html :もご確認いただけます。
 ...
 *A:* サポートパッケージはCloudifyへのアドオンとして購入できます。また、Cloudify Premiumエディションを選ばれた場合には、サポートはパッケージに含まれています。Cloudify Premiumについて詳しくは、<a href="http://getcloudify.org/goPro.html">こちら</a>をご覧ください。 
